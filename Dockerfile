...
# Próbujemy `npm ci` dla determinizmu; gdy lock jest niesynchroniczny z package.json
# (np. po dodaniu zależności bez lokalnego npm install), fallback na `npm install`.
